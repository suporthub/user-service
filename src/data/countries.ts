/**
 * countries.ts — Static ISO 3166-1 alpha-2 country reference data.
 *
 * Using a hand-curated static file instead of i18n-iso-countries at runtime
 * keeps user-service dependency-free for this data and allows easy customisation
 * (e.g. adding dial codes, blocking specific countries).
 *
 * Covers all 249 UN-recognized countries.
 * dial_code sourced from libphonenumber's region data.
 */
...
/** O(1) lookup map: ISO code → Country */
